...
영역이다. JSP에서의 영역은 데이터를 저장하는 공간으로 메모리라고 생각하면 된다.
*/
//정수형(Integer) 데이터
...
<body>
	...
	/*
		...
		Object형으로 자동형변환되어 저장되므로 값을 읽을 때는 원래의 형으로
		다운캐스팅(강제형변환) 후 사용해야 한다.
	*/
	%>
	<ul>
		<!-- Java의 기본클래스는 별도의 처리없이 즉시 내용을 처리할 수 있다. -->
	...
	<!-- 지시어를 총한 include는 포함시킬 페이스의 원본소스를 그대로
	현재 문서에 포함시킨 후 컴파일을 진행한다. 따라서 통일한 페이지로 
