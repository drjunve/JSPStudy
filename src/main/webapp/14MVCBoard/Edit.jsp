...
<!-- 기존 등록된 파일명. 만약 수정페이지에서 첨부파일을 변경하지 않는다면
여기에 등록된 파일명을 그대로 사용해서 update할 예정이다. -->
...
<table border="1" width="90%">
    ...
    <tr>
        <td>첨부 파일</td>
        <td>
        	<!-- 파일의 경우에는 value속성을 사용하지 않는다. 먄약 사용한다하더라도
        	단순한 String정보이므로 의미가 없다. -->
